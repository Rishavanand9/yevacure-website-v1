...
function Products() {
  return (
    ...
    {images.map((item,index)=>{
      return(<div className="product-list-card" key={index}>
      <img className="product-list-image" src={ProductLogo} alt="error"/>
      <div className="product-list-container">
      <div className="product-name">Product Name</div>
      <div className="product-description">lorem ipsumlorem ipsumlorem ipsumlorem ipsumlorem ipsumlorem
       ipsumlorem ipsum</div>
      </div>
